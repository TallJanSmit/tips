...
- Special Priviliges should not be given. Our answer: Permanent special priviliges should not be given. One-off special priviliges should only be given if it generates a significant benefit to the chain and no other pratical option exists. We believe this is such an example.
